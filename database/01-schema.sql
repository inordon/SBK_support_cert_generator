...
CREATE INDEX IF NOT EXISTS idx_certificates_domain_active ON certificates(domain, is_active);
CREATE INDEX IF NOT EXISTS idx_certificates_active_valid ON certificates(is_active, valid_from, valid_to);
CREATE INDEX IF NOT EXISTS idx_certificates_created_by_date ON certificates(created_by, created_at);
CREATE INDEX IF NOT EXISTS idx_certificate_history_cert_id ON certificate_history(certificate_id);
CREATE INDEX IF NOT EXISTS idx_certificate_history_action ON certificate_history(action);
CREATE INDEX IF NOT EXISTS idx_certificate_history_performed_at ON certificate_history(performed_at);
CREATE INDEX IF NOT EXISTS idx_certificate_history_performed_by ON certificate_history(performed_by);
CREATE INDEX IF NOT EXISTS idx_certificate_history_details ON certificate_history USING gin(details);
CREATE INDEX IF NOT EXISTS idx_certificates_domain_trgm ON certificates USING gin(domain gin_trgm_ops);
...
DROP TRIGGER IF EXISTS trigger_certificate_changes ON certificates;
...
DROP TRIGGER IF EXISTS trigger_unique_active_domain ON certificates;
...
CREATE OR REPLACE VIEW certificates_with_history AS
SELECT
    c.*,
    (
        SELECT json_agg(
